...
#
# Generated by export_simulation on Tue Sep 29 14:19:18 MSK 2020
#
################################################################################
...
'-reset_run' switch to the './cic_d10.sh' script.

./cic_d10.sh -reset_run
...
./cic_d10.sh -noclean_files

For more information on the script, please type './cic_d10.sh -help'.
