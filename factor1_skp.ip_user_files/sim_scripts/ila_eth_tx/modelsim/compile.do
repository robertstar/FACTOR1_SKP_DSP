...
vlog -work xpm -64 -incr -sv "+incdir+../../../ip/ila_eth_tx/hdl/verilog" \
...
vlog -work xil_defaultlib -64 -incr "+incdir+../../../ip/ila_eth_tx/hdl/verilog" \
"../../../ip/ila_eth_tx/sim/ila_eth_tx.v" \
